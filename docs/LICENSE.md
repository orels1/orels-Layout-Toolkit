This license file applies to the base template and components in this repository. As such, I would not recommend copying this documentation site's source code verbatim if you do not own Tailwind UI yourself.
